...
Material::Material(const Texture *texture) : _type(Textured), _texture(texture), _diffuseFac(1.0)
{}

Material::Material(const Texture *texture, double diffuseFac, double specularFac, double reflectiveFac, double glossy,
                   double phongConst, const glm::dvec3 &specularColor) :
                   _type(Textured), _texture(texture), _diffuseFac(diffuseFac), _specularFac(specularFac),
                   _reflectiveFac(reflectiveFac), _glossyFac(glossy), _phongConst(phongConst),
                   _specularColor(specularColor)
{}
