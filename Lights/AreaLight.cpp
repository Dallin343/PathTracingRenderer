...
AreaLight::AreaLight(const glm::dvec3 &pos, const glm::dvec3 &u, const glm::dvec3 &v, double w, double h,
                     const glm::dvec3 &col, double intensity) : Light(pos, col, intensity), _u(glm::normalize(u)),
                                                                _v(glm::normalize(v)), _width(w), _height(h) {}
